...
function Login ({ onLogin }) {
    ...
    return (
        <section className="form">
            ...
            <form onSubmit={handleSubmit} className="form__container" name='loginForm' noValidate>
                <h3 className="form__title">Simple Hotel Check</h3>
                <label className="form__field">
                    <span className={`${formValidation.errors.login ? "form__field-text_invalid" : ""} form__field-text`}>Логин</span>
                ...
                <label className="form__field">
                    <span className={`${formValidation.errors.password ? "form__field-text_invalid" : ""} form__field-text`}>Пароль</span>
